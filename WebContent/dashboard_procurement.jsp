...
<body>
    ...
    <div class="container">
        ...
        <div class="card-grid">
            ...
            <a class="module-card" href="PurchaseOrderServlet?action=filter&status=ALL" style="text-decoration:none; display:block;">
                <h4>Track Procurement Status</h4>
                <p>Monitor the status of all active procurement requests.</p>
            </a>
            <a class="module-card" href="purchase_orders.jsp#supplier-performance" style="text-decoration:none; display:block;">
