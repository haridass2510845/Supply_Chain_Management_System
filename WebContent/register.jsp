    ...
    <div class="login-wrapper">
        <div class="login-box">
            <div class="brand-strip">
                ...
                <p class="subtitle">Get access to your role's dashboard. We'll email you a verification code.</p>
            </div>
            ...
            <% if ("true".equals(request.getParameter("expired"))) { %>
                <div class="alert alert-error">Your verification session expired or was lost. Please fill in the form again.</div>
            <% } %>
